...
<section class="wishlist">
    ...
    <h1 class="title">Produk Tersimpan</h1>
    ...
    <form action="" method="POST" class="box">
        <a href="wishlist.php?delete=<?php echo $fetch_wishlist['id']; ?>" class="fas fa-times" onclick="return confirm('Hapus produk ini dari wishlist?');"></a>
        <!-- Made image clickable using anchor tag like in shop page -->
    ...
    <div class="wishlist-total">
        <p>Total : <span><?php echo format_rupiah($grand_total); ?></span></p>
